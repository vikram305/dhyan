...
class EntriesRecyclerAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    fun setPosts(machineList:List<Machine>){
        ...
        Log.d(TAG, "posts list size:${machines.size}")
    ...
    class MachineViewHoder(itemView: View): RecyclerView.ViewHolder(itemView){
        ...
        fun bind(machine: Machine){
            machineName.text="Machine Name: ${machine.name}111111111111111111111111111"
            addedDate.text="Added At: ${machine.addedDate}11111111111111111111"
        }
    }
}